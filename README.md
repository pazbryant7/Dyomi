...
|-------|----------|----------|
| [![Preview](https://github.com/pazbryant7/DyomiPreview/workflows/Remote%20Dispatch%20Build%20App/badge.svg)](https://github.com/pazbryant7/DyomiPreview/releases) | [![stable release](https://img.shields.io/github/release/pazbryant7/Dyomi.svg?maxAge=3600&label=download)](https://github.com/pazbryant7/Dyomi/releases/latest) | [![Discord](https://img.shields.io/discord/1195734228319617024.svg?label=discord&labelColor=7289da&color=2c2f33&style=flat)](https://discord.gg/mihon) |


# ![app icon](./.github/readme-images/app-icon.png)Dyomi
Mihon is a free and open source manga reader for Android 8.0 and above. Dyomi is based on Mihon and TachiyomiAZ. This version is meant to push forward in the ways of usability and features. Dyomi tries to push forward where it can, but staying in a place where it can easily grab updates and features from the main app, it tries to make new features, or take features from other forks like J2K and Neko.
...
## Download
Get the app from our [releases page](https://github.com/pazbryant7/Dyomi/releases/latest).

If you want to try new features before they get to the stable release, you can download the preview version [here](https://github.com/pazbryant7/DyomiPreview/releases).
...
1. **Before reporting a new issue, take a look at the [FAQ](https://mihon.app/docs/faq/general), the [changelog](https://github.com/pazbryant7/Dyomi/releases) and the already opened [issues](https://github.com/pazbryant7/Dyomi/issues).**
...
Use the [issue forms](https://github.com/pazbryant7/Dyomi/issues/new/choose) to submit a bug.
